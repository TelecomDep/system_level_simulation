...
class debug_samples(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "debug_samples")
        ...
        # Variables
        ##################################################
        self.y_lim = y_lim = 400
        self.samp_rate = samp_rate = 11520000
        self.num_samples = num_samples = 3152000
        ...
        self.qtgui_time_sink_x_0_2.set_y_axis(-1, y_lim)

        self.qtgui_time_sink_x_0_2.set_y_label('', "")
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-1, y_lim)
        ...
        self.qtgui_time_sink_x_0_0_1.set_y_axis(-1, y_lim)
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(-1, y_lim)

        self.qtgui_time_sink_x_0_0_0_0.set_y_label('', "")
        ...
        self.qtgui_time_sink_x_0_0.set_y_axis(-1, y_lim)
        ...
        self.blocks_head_0_0_0_0_0 = blocks.head(gr.sizeof_gr_complex*1, num_samples)
        self.blocks_head_0_0_0_0 = blocks.head(gr.sizeof_gr_complex*1, num_samples)
        self.blocks_head_0_0_0 = blocks.head(gr.sizeof_gr_complex*1, num_samples)
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, num_samples)
        self.blocks_file_source_0_2 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue3.log', False, 0, 0)
        self.blocks_file_source_0_2.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue2.log', False, 0, 0)
        self.blocks_file_source_0_1.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue1.log', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_multi.log', False, 0, 0)
        ...
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_head_0_0_0, 0))
        self.connect((self.blocks_file_source_0_1, 0), (self.blocks_head_0_0_0_0, 0))
        self.connect((self.blocks_file_source_0_2, 0), (self.blocks_head_0_0_0_0_0, 0))
        self.connect((self.blocks_head_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 3))
        self.connect((self.blocks_head_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
        self.connect((self.blocks_head_0_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_head_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_head_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 1))
        self.connect((self.blocks_head_0_0_0_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.blocks_head_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 2))
        self.connect((self.blocks_head_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_2, 0))
    ...
    def set_y_lim(self, y_lim):
        self.y_lim = y_lim
        self.qtgui_time_sink_x_0_0.set_y_axis(-1, self.y_lim)
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(-1, self.y_lim)
        self.qtgui_time_sink_x_0_0_1.set_y_axis(-1, self.y_lim)
        self.qtgui_time_sink_x_0_1.set_y_axis(-1, self.y_lim)
        self.qtgui_time_sink_x_0_2.set_y_axis(-1, self.y_lim)
    ...
    def set_num_samples(self, num_samples):
        ...
        self.blocks_head_0_0_0.set_length(self.num_samples)
        self.blocks_head_0_0_0_0.set_length(self.num_samples)
        self.blocks_head_0_0_0_0_0.set_length(self.num_samples)




def main(top_block_cls=debug_samples, options=None):
