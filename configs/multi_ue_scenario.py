...
class multi_ue_scenario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ue2_path_loss_db = ue2_path_loss_db = 30
        ...
        self._ue2_path_loss_db_range = qtgui.Range(0, 100, 1, 30, 200)
        ...
        self._seed_awgn_range = qtgui.Range(-1, 1, 0.002, 0.0120, 200)
        self._seed_awgn_win = qtgui.RangeWidget(self._seed_awgn_range, self.set_seed_awgn, "noise", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_time_sink_x_0_0_1_0.set_y_axis(-1000, 1000)

        self.qtgui_time_sink_x_0_0_1_0.set_y_label('UE3', "")
        ...
        self.qtgui_time_sink_x_0_0_1.set_y_axis(-1000, 1000)

        self.qtgui_time_sink_x_0_0_1.set_y_label('UE2', "")
        ...
        self.qtgui_time_sink_x_0_0.set_y_axis(-1000, 1000)

        self.qtgui_time_sink_x_0_0.set_y_label('UE1', "")
        ...
        self._noise_range = qtgui.Range(0, 100, 1, 0, 200)
        ...
        self.blocks_file_sink_0_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue3.log', False)
        self.blocks_file_sink_0_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue2.log', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_ue1.log', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nsk/dev/system_level_simulation/logs/gnu_multi.log', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_file_sink_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_file_sink_0_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.qtgui_time_sink_x_0_0_1_0, 0))
        ...
        self.connect((self.zeromq_req_source_0, 0), (self.blocks_multiply_const_vxx_0_1, 0))
        self.connect((self.zeromq_req_source_0, 0), (self.blocks_multiply_const_vxx_0_1_0, 0))
        self.connect((self.zeromq_req_source_0, 0), (self.blocks_multiply_const_vxx_0_1_1, 0))
