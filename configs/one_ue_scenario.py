...
class one_ue_scenario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "one_ue_scenario")
        ...
        self.samp_rate_0 = samp_rate_0 = 11520000
...
def main(top_block_cls=one_ue_scenario, options=None):
